"""
Django settings for biheybazar project.
...
SECRET_KEY = 'yim8q#2mz*hgx&c5bc9b+_ypi1qa_j=z*@oaqw(4yu!(rt3le1'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'biheybazar.custom_context_processors.customer_vendor',
            ],
        },
    },
]
...
WSGI_APPLICATION = 'biheybazar.wsgi.application'
